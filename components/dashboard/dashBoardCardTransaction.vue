        ...
        >
          ...
          <div class="d-flex align-center flex-grow-1 flex-wrap">
            ...
            <div class="d-flex align-center">
              ...
              >
                {{ data.transaction.charAt(0) === '+' ? 'mdi-chevron-up' :'mdi-chevron-down' }}
              </v-icon>
            </div>
          </div>
        </v-list-item>
...
export default {
    name: 'DashBoardCardTransaction',
    data: () => ({
        transactionData: [
            {
                avatar: require('@/assets/images/pages/paypal.png'),
                avatarColor: 'error',
                title: 'Paypal',
            ...
            {
                avatar: require('@/assets/images/pages/credit-card.png'),
                avatarColor: 'success',
                title: 'Credit Card',
            ...
            {
                avatar: require('@/assets/images/pages/wallet.png'),
                avatarColor: 'primary',
                title: 'Wallet',
                subtitle: "Mac'D",
                transaction: '-$82',
